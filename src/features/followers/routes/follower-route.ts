...
import { AddBlock } from '@follower/controllers/block-user';
class FollowerRoutes {
  ...
  public routes(): Router {
    ...
    this.router.put('/user/block/:followerId', authMiddleware.checkAuthentication, AddBlock.prototype.block);
    this.router.put('/user/unblock/:followerId', authMiddleware.checkAuthentication, AddBlock.prototype.unblock);
